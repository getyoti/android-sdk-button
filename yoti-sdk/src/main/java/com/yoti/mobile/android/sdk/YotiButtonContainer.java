...
abstract class YotiButtonContainer extends RelativeLayout {
    ...
    private ButtonTheme sdkButtonTheme;
    ...
    protected ButtonTheme getSdkButtonTheme() {
        return sdkButtonTheme;
    }
